  ...
  return (
    <Box sx={{
      ...
      <Typography
        ...
        component="h1"
        gutterBottom
        sx={{ color: '#333333', fontWeight: 600, mb: 4 }}
      >
        Analytics
      </Typography>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} md={4}>
          <Card sx={{ height: '100%', background: '#ffffff', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.05)' }}>
            <CardContent>
              <Typography variant="h6" sx={{ color: '#555555', fontWeight: 500, mb: 1 }}>
                Total Expenses
              </Typography>
              <Typography variant="h4" sx={{ color: '#333333', fontWeight: 600 }}>
